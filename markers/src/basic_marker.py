...
class MarkerBasics(object):
    ...
    def init_marker(self,index=0, z_val=0):
        ...
        self.marker_object.pose.orientation.x = -4
        self.marker_object.pose.orientation.y = -2
        self.marker_object.pose.orientation.z = 0.0
        self.marker_object.pose.orientation.w = 1.0
        self.marker_object.scale.x = 0.12
        self.marker_object.scale.y = 0.12
        self.marker_object.scale.z = 0.12
